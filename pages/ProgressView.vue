    ...
    data () {
      return {
        doc: {
          ...
          examples: [
            { header: 'Default', file: 'progress-circular/1', desc: ''},
            { header: 'Colored', file: 'progress-circular/2', desc: ''},
            { header: 'Indeterminate', file: 'progress-circular/3', desc: ''},
            { header: 'Size & Width', file: 'progress-circular/4', desc: ''},
            { header: 'Rotate', file: 'progress-circular/5', desc: ''},
            { header: 'Determinate', file: 'progress-linear/1', desc: ''},
            { header: 'Indeterminate', file: 'progress-linear/2', desc: ''},
