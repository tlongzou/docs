  ...
  doc-view(id="quick-start-view")
    ...
    section
      ...
      v-tabs(class="elevation-1 mb-5" grow icons)
        v-tab-item(ripple href="#simple" slot="activators") Simple HTML
          v-icon landscape
        v-tab-item(ripple href="#webpack" slot="activators") Webpack
          v-icon web
        v-tab-item(ripple href="#webpack-advanced" slot="activators") Webpack Advanced
          v-icon layers
        v-tab-item(ripple href="#webpack-ssr" slot="activators") Webpack SSR
          v-icon cloud_circle
        v-tab-item(ripple href="#nuxt" slot="activators") NUXT
          v-icon flash_on
        ...
        v-tab-content(id="webpack-advanced" slot="content")
          v-card
            v-card-text
        ...
        v-tab-content(id="nuxt" slot="content")
          v-card
            v-card-text
              h4 NUXT Quick Start
