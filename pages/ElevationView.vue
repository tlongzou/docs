<template lang="pug">
  .view(id="elevation-view")
    ...
    section
      h6 Variants
      p.mb-5 There's a total of 25 elevation levels. You can set an element elevation by using the class <code>elevation-N</code>, where N is a integer between 0-24 corresponding to the desired elevation.
