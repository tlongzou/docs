    ...
    data () {
      return {
        items: [
          { header: 'Today' },
          {
            avatar: '/public/doc-images/lists/1.jpg',
          ...
          {
            avatar: '/public/doc-images/lists/2.jpg',
          ...
          { divider: true, inset: true },
          {
            avatar: '/public/doc-images/lists/5.jpg',
            title: 'Recipe to try',
